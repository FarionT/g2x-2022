...
<html lang="en">
    ...
    <body id="index">
        <div class="container-fluid justify-content-center m-0 p-0">
            ...
            <br /><br /><br /><br /><br /><br /><br /><br /><br />
            <br /><br /><br />
            <h2 class="button-arrow text-center game-entries-def mb-5 font_title">GAME ENTRIES →</h2>
            <h2 class="button-arrow text-center game-entries-resp mb-5 font_title">GAME ENTRIES</h2>
